...
mod test {
    ...
    fn test_store_work_out_of_sequence_work_id() {
        let mut registry = MiningWorkRegistry::new();
        let work1 = dummy::prepare_test_work(0);
        let work2 = dummy::prepare_test_work(1);
        // store initial work
    ...
    fn test_store_work_retiring() {
        ...
        for id in 0..MAX_WORK_LIST_COUNT {
            let work = dummy::prepare_test_work(id as u64);
        ...
        registry.store_work(0, dummy::prepare_test_work(0));
        assert!(
